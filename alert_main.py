...
# [수정] 웹훅 URL이 환경변수에 없으면 기본값으로 문자열을 사용하도록 수정
default_webhook_url = "https://hooks.slack.com/services/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"
slack_webhook_url = os.environ.get("SLACK_WEBHOOK_URL", default_webhook_url)
